...
export default function FullStackProjects() {
  ...
  const fullStackProjects = projectsData.filter(p => p.type === 'FullStack');
        ...
        <motion.div ref={ref}>
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Real-world applications built with modern tech stack including React, Node.js, and databases
            </p>
          </motion.div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-3 py-1 text-xs rounded-full bg-primary/30 text-accent border border-primary/50"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="flex gap-3 pt-4">
                    <motion.a
                      ...
                      className="flex-1 px-4 py-2 bg-primary/30 hover:bg-primary/50 rounded-lg text-center text-sm font-semibold transition"
